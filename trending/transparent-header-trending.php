                    ...
                    <div class="row mx-0">
                      <div class="col-sm-6 dropdown-menu-col">
                        ...
                        <ul class="nav flex-column">
                          <li class="nav__item"><a class="nav__item-link" <?php if($page == 'web-design-and-development.php' ){ echo 'id="thisSubPageIsActive"';}?> href="web-design-and-development.php">Web Design & Development</a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link" <?php if($page == 'seo-services.php' ){ echo 'id="thisSubPageIsActive"';}?>  href="seo-services.php">SEO Services</a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link" <?php if($page == 'software-development.php' ){ echo 'id="thisSubPageIsActive"';}?> href="software-development.php">Software Development</a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link" <?php if($page == 'it-consulting-and-suppport.php' ){ echo 'id="thisSubPageIsActive"';}?> href="it-consulting-and-suppport.php">IT Consulting & Support</a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link" <?php if($page == 'mobile-app-development.php' ){ echo 'id="thisSubPageIsActive"';}?> href="mobile-app-development.php">Mobile App Development</a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link" <?php if($page == 'site-speed-optimization.php' ){ echo 'id="thisSubPageIsActive"';}?> href="site-speed-optimization.php">Site Speed Optimization</a>
                          </li>
                          <!-- /.nav-item -->
                        </ul>
                      </div><!-- /.col-sm-6 -->
