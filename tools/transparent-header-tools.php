        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav ml-auto">
                    ...
                    <div class="row mx-0">
                      <div class="col-sm-6 dropdown-menu-col">
                        ...
                        <ul class="nav flex-column">
                          <li class="nav__item"><a class="nav__item-link" href="web-design-and-development.php">Web Design & Development</a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link"  href="seo-services.php">SEO Services</a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link" href="software-development.php">Software Development</a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link" href="it-consulting-and-suppport.php">IT Consulting & Support</a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link" href="mobile-app-development.php">Mobile App Development</a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link"  href="site-speed-optimization.php">Site Speed Optimization</a>
                          </li>
                          <!-- /.nav-item -->
                        </ul>
                      </div><!-- /.col-sm-6 -->
              ...
              <li class="nav__item  has-dropdown">
                <a href="#" data-toggle="dropdown" class="dropdown-toggle nav__item-link active">Features</a>
                <ul class="dropdown-menu">
                  <li class="nav__item">
                    <a href="../web-hosting" class="nav__item-link">Web Hosting</a>
                  </li><!-- /.nav-item -->
                  <li class="nav__item">
                    <a href="../tools"  <?php if($page == 'index.php' ){ echo 'id="thisSubPageIsActive"';}?> class="nav__item-link">Free Tools</a>
                  </li><!-- /.nav-item -->
                </ul><!-- /.dropdown-menu -->
              </li><!-- /.nav-item -->
              <li class="nav__item  has-dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav__item">
                    <a href="web-hosting/" target = "_blank" class="nav__item-link">Online Courses</a>
                  </li><!-- /.nav-item -->
                  <li class="nav__item">
