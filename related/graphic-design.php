...
<head>
  ...
  <title>Graphic Design | Evox Solutions | Digital Marketing Agency</title>
...
<body>
  <div class="wrapper">
    ...
    <?php include('transparent-header-related.php');?>
          ...
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
            ...
            <nav>
              <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="it-solutions.html">Related Solutions</a></li>
